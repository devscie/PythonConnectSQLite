...
"""
    Gerenciamento de um banco de dados SQLite (sqlite3).
    Pode-se usar o modo interativo com python3 ou ipython3.
...
class ClientesDb(object):
    ...
    def inserir_um_registro(self):
        try:
            ...
            VALUES ('Carlos da Silva', 35, '12345678901', 'carlos@email.com', '(11) 9876-5342',
    ...
    def inserir_com_lista(self):
        ...
        lista = [('Luisa de Sousa', 23, '12345678901', 'agenor@email.com',
                  '(10) 8300-0000', 'Salvador', 'BA', '2014-07-29 11:23:01.199001'),
                ('Debora Antunes', 21, '12345678902', 'bianca@email.com',
                  '(10) 8350-0001', 'Fortaleza', 'CE', '2014-07-28 11:23:02.199002'),
                ('Jaqueline Ribeiro', 30, '12345678903', 'carla@email.com',
                  '(10) 8377-0002', 'Campinas', 'SP', '2014-07-28 11:23:03.199003'),
                ('Fabiola de Almeida', 25, '12345678904', 'fabiana@email.com',
    ...
    # print_simple_all_customer
    def imprimir_simples_todos_clientes(self):
        lista = self.ler_todos_clientes()
        for c in lista:
            print(c)
